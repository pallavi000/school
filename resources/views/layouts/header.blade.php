...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class=" navbar-collapse collapse offset-md-1" id="navbarSupportedContent"  >
          <form class="form-inline my-2 my-lg-0 navbar-nav navbar-right">
          <li class="nav-item"><a href="#"  class="nav-link">Education</a></li>
        <li class="nav-item"><a   class="nav-link" href="{{route('page')}}">Research</a></li>
        <li class="nav-item"><a href="#"  class="nav-link">Innovation</a></li>
        ...
        <li class="nav-item"><a href="#" class="nav-link">Almuni</a></li>
        <li class="nav-item"><a href="#" class="nav-link">About MIT</a></li>
        <li class="nav-item"><a href="#" class="nav-search-border">
